...
O guia também cita algumas condições iniciais para que a VSE possa utilizá-lo \cite{iso}:
...
\item[PM.03] A \muda é abordada através de sua recepção e análise. Mudanças nos requisitos de \sw são avaliadas em custo, cronograma e impacto técnico.
